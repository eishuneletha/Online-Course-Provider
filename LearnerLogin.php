...
if (isset($_POST['btnlogin'])) {
  ...
  if ($checkcount == 1) {
    $lfetch = $stmt->fetch(PDO::FETCH_BOTH);
    echo "<script>window.alert('Welcome Learner. Login Successful')</script>";
    $_SESSION['LID'] = $lfetch['LearnerID'];
    echo "<script>window.location='index.php'</script>";
    $_SESSION['learnerlogin'] = 1;
  } else {
        ...
        <div class=" course-form-section col-sm-12  col-md-12  col-lg-8">
          ...
          <form class="course-form-area contact-page-form course-form " id="myForm" action="" method="POST">
            ...
            <div class=" col-sm-12 col-md-12 col-lg-12" style="color:white; ">
              ...
              <div class="col-lg-12 text-center">
                <p style="padding-top:15px">Don't have an account?</p>
                <button class="btn text-uppercase" ><a href="LearnerRegister.php" style="color:white ;">Learner Register</a></button>
              </div>
