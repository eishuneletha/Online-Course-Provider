...
if(isset($_POST['btnsubmit']))
{
    ...
    $check=$conn->prepare("SELECT * from instructors where Email=:email");
    ...
    if($check->rowCount()>0)
    {
        ...
        $insert="INSERT into instructors (InstructorName,Email,Password,ProfilePicture,About,Interestedcategories,status,InstructorSince) values (:name,:email,:password,:uimg,:about,:cat,:status,:date)";
        ...
        $stmt->bindParam(":cat",$chk);
        $run=$stmt->execute();

        if($run)
        {
            echo "<script>window.alert('Instructor Registration successful. You will be able to login to your account within 2 or 3 business days')</script>";
            ...
            <div class="row justify-content-center">
                ...
                <div class=" col-lg-10 col-md-12">
                    <div class="course-form-section">
                        <h3 class="text-white">Teach on Educally</h3>
                        ...
                        <form class="course-form-area contact-page-form course-form" id="myForm" action="" method="post" enctype="multipart/form-data">
                            ...
                            <div class=" col-sm-12 col-md-12 col-lg-12" style="color:white; ">
                                ...
                                <div class="row form-group col-md-12">
                                    ...
                                    <div class="col-md-9">
                                        <textarea  class="common-textarea form-control" name="about" placeholder="Tell us a lil bit about yourself" onfocus="this.placeholder = ''" onblur="this.placeholder = ''"></textarea>
                                ...
                                <div class="row form-group col-md-12">
                                    <div class="col-md-3" style="padding-top: 15px;padding-bottom:15px ;">
                                        In what field(s) are you interested in? :
                                    </div>
                                    <div class="col-md-9" style="text-align:left;">
                                        ...
                                        for ($i = 0; $i < $ccount; $i++) {
                                            ...
                                            echo "<input style='width:15px; height:15px; ' type='checkbox' name='category[]' value='$cname'>";
                                            echo "<label style='padding-left:10px' >$cname</label>";
                                            echo "</br>";
                                ...
                                <div class="col-lg-12 text-center">
                                    <button class="btn text-uppercase" name="btnsubmit">Register</button> <br><br><br>
                                    <p>Already are an instructor on Edcually? Login as instructor here</p>
                                    
                                    <button class="btn text-uppercase" ><a href="InstructorLogin.php" style="color:white ;"> Login</a></button>
