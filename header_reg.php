      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse justify-content-end align-items-center" id="navbarSupportedContent">
          ...
          <ul class="navbar-nav">
            ...
            <!-- <li><a href="InstructorRegister.php" style=" padding:10px; margin-right:10px; background-color:#FE993F;">Teach at Educally</a></li> -->
            <li><a href="LearnerLogin.php" style=" padding:10px;background-color:#D54335;">Learn at Educally</a></li>


            <li>
              <a href="#">
                <img style="width:40px; border-radius: 50%;  margin-top:-10px " src="img/blog/profilebeforelogin.jpg" alt="">
              </a>
